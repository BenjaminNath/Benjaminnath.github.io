...
q.prototype.A=function(){if(this.o)for(;this.o.length;)this.o.shift()()};function r(){q.call(this);this.c=[];this.c[3]=[];this.c[2]=[];this.c[1]=[];this.c[0]=[];this.f={};this.l=r.c;this.B=this.m=0;this.w=this.v=!1;this.h=[];this.C=l(this.D,this)}
(function(){var a=r;function b(){}
b.prototype=q.prototype;a.F=q.prototype;a.prototype=new b;a.prototype.constructor=a;a.base=function(a,b,e){for(var w=Array(arguments.length-2),p=2;p<arguments.length;p++)w[p-2]=arguments[p];return q.prototype[b].apply(a,w)}})();
r.j="hidden";r.f=1E3/60;r.h=3;r.c=r.f-3;function t(a,b,c,d){++a.B;var e=a.B;a.f[e]=b;a.v&&!d?a.h.push({id:e,priority:c}):(a.c[c].push(e),a.w||a.v||u(a));return e}
...
function u(a){a.w=!1;0==a.m&&(a.m=window.setTimeout(a.C,1))}
r.prototype.pause=function(){this.stop();this.w=!0};
r.prototype.stop=function(){window.clearTimeout(this.m);this.m=0};
r.prototype.A=function(){v(this);this.stop();r.F.A.call(this)};function y(){var a=g("yt.scheduler.instance.instance_");if(!a||a.isDisposed())a=new r,n("yt.scheduler.instance.instance_",a);return a}
